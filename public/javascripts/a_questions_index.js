...
function validateData(data = -1) {
    ...
    if (data.course == null || data.course.includes("Choose") || data.course.length <= 0) {
        alert("Course Can't be Empty");
        document.getElementById("inputStateCourse").classList.add('border', 'border-2', 'border-top-0', 'border-danger');
        return -1;
    } else {
        document.getElementById("inputStateCourse").classList.remove('border', 'border-2', 'border-top-0', 'border-danger');
    }
    ...
    if (data.questionData.question.length <= 0 || data.questionData.question == '' || data.questionData.question == "") {
        ...
        if (tinyMCE.get('questionTextArea').getContent().length > 0) {
            ...
            document.getElementById("questionForm").classList.add('border');
            return -1;
        }
    } else {
        document.getElementById("questionForm").classList.remove('border');
    }
    ...
    if (data.questionData.answer.includes("Choose") || data.questionData.answer.length <= 0) {
        ...
        document.getElementById("inputStateAnswer").classList.add('border', 'border-2', 'border-top-0', 'border-danger');
        return -1;
    } else {
        document.getElementById("inputStateAnswer").classList.remove('border', 'border-2', 'border-top-0', 'border-danger');
    }
    ...
    if (data.questionData.option_1.length <= 0 || data.questionData.option_2.length <= 0 || data.questionData.option_3.length <= 0 ||
        ...
        document.getElementById("floatingFormareaOption1").classList.add('border', 'border-1', 'border-top-0', 'border-dark');
        document.getElementById("floatingFormareaOption2").classList.add('border', 'border-1', 'border-top-0', 'border-dark');
        document.getElementById("floatingFormareaOption3").classList.add('border', 'border-1', 'border-top-0', 'border-dark');
        document.getElementById("floatingFormareaOption4").classList.add('border', 'border-1', 'border-top-0', 'border-dark');
        return -1;
    } else {
        document.getElementById("floatingFormareaOption1").classList.remove('border', 'border-1', 'border-top-0', 'border-dark');
        document.getElementById("floatingFormareaOption2").classList.remove('border', 'border-1', 'border-top-0', 'border-dark');
        document.getElementById("floatingFormareaOption3").classList.remove('border', 'border-1', 'border-top-0', 'border-dark');
        document.getElementById("floatingFormareaOption4").classList.remove('border', 'border-1', 'border-top-0', 'border-dark');
    }
...
function makeQuestionValidationData() {
    ...
    // .replace(/(<p>|<br>)*<\/?(p|br)[^>]*>/g, "")
    //console.log(tinyMCE.get('questionTextArea').getContent());
    const questionData = {
            question_id: question_id,
...
//         var editorPromise = editors[0] ? editors[0].uploadImages() : Promise.resolve();
...
// function uploadSubmitQuestionData() {
//     var isSubmited = false;
//     console.log("uploadSubmitQuestionData");

//     var questionHasImage = tinyMCE.get('questionTextArea').getContent().includes("<img");
//     //console.log("questionHasImage", questionHasImage);

//     var textareas = document.getElementById("accordionExample").querySelectorAll("textarea");
//     // console.log("textareas", textareas);


//     var translationsHasImage = false;
//     for (var i = 0; i < textareas.length; i = i + 5) {
//         if (tinyMCE.get(textareas[i].id).getContent().includes("<img")) {
//             translationsHasImage = true;
//         }
//     }
//     // console.log("translationsHasImage", translationsHasImage);



//     if (questionHasImage && translationsHasImage && !isSubmited) {

//         editors[0].uploadImages().then(function() {
//             // console.log("editors[0].uploadImages().then", imageLocArray[0]);
...
//                 if (tinyMCE.get(textareas[i].id).getContent().includes("<img")) {
//                     // console.log("textareas[i].id etContent().includes(<img)", i, textareas[i].id);

//                     tinyMCE.get(textareas[i].id).uploadImages().then(function() {
//                         // console.log(imageLocArray)
//                         if (!isSubmited) {
//                             submitquestion();
//                             isSubmited = true;
//                             // console.log("submitquestion() done")
//                             alert("Save Successfull")
//                             // // location.reload();
//                         }
//                     })
...
//             // // location.reload();
//         });
//     } else if (translationsHasImage && !isSubmited) {
//         console.log("translationsHasImage");
//         for (var i = 0; i < textareas.length; i = i + 5) {
//             if (tinyMCE.get(textareas[i].id).getContent().includes("<img")) {
//                 tinyMCE.get(textareas[i].id).uploadImages().then(function() {
//                     submitquestion();
